...
#define V 7 // Vertices of graph
#define E 9 //  edges of graph
...
void KrushkalMCST(int A[3][9])
{
    int T[2][V-1];//Solution array
    int track[E]{0};//Tracking edges included in the solution
    int set[V+1] = {-1}; //array for finding cycle
